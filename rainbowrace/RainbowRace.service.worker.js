...
/** @type {string} */
const CACHE_VERSION = '1762879990|154983353501';
/** @type {string} */
const CACHE_PREFIX = 'RainbowRace-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'RainbowRace.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["RainbowRace.html","RainbowRace.js","RainbowRace.offline.html","RainbowRace.icon.png","RainbowRace.apple-touch-icon.png","RainbowRace.audio.worklet.js","RainbowRace.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["RainbowRace.wasm","RainbowRace.pck"];
